...
public class EquipmentGroupService : IEquipmentGroupService
{
    ...
    /// <returns>A serviceResponse containing the equipment groups that match the query.</returns>
    public async Task<ServiceResponse<QueryResponseDto<EquipmentGroup>>> GetAsync(QueryRequestDto query)
    {
    ...
    public async Task<ServiceResponse<EquipmentGroup>> GetByIdAsync(int id)
    {
        if (id <= 0)
        {
            _logger.LogWarning(ServiceMessages.EntityIdInvalid<EquipmentGroup>());
            return ServiceResponse.Failure<EquipmentGroup>(EntityErrorMessage<EquipmentGroup>.BadRequest());
        }
        ...
        if (result == null)
        {
            ...
            return ServiceResponse.Failure<EquipmentGroup>(EntityErrorMessage<EquipmentGroup>.NotFound(id));
        }
    ...
    /// <returns>A <see cref="Task{ServiceResponse{int}}"/> indicating the asynchronous operation, with a serviceResponse containing the ID of the created equipment group if successful.</returns>
    public async Task<ServiceResponse<int>> CreateAsync(EquipmentGroup entity)
    {
        ...
        if (!validationResult.IsValid)
        {
            ...
            return ServiceResponse.Failure<int>(EntityErrorMessage<EquipmentGroup>.BadRequest(validationResult.ToDictionary()));
        }
    ...
    /// <returns>A serviceResponse indicating if the update operation was successful.</returns>
    public async Task<ServiceResponse<bool>> UpdateAsync(EquipmentGroup entity)
    {
        ...
        {
            _logger.LogWarning(ServiceMessages.EntityValidationFailure<EquipmentGroup>(validationResult.ToDictionary()));
            return ServiceResponse.Failure<bool>(EntityErrorMessage<EquipmentGroup>.BadRequest(validationResult.ToDictionary()));
        }
    ...
    public async Task<ServiceResponse<bool>> DeleteAsync(int id)
    {
        ...
        {
            _logger.LogWarning(ServiceMessages.EntityIdInvalid<EquipmentGroup>());
            return ServiceResponse.Failure<bool>(EntityErrorMessage<EquipmentGroup>.BadRequest());
        }
        ...
        {
            _logger.LogWarning(ServiceMessages.EntityNotFound<EquipmentGroup>(id));
            return ServiceResponse.Failure<bool>(EntityErrorMessage<EquipmentGroup>.NotFound(id));
        }
    ...
    public async Task<ServiceResponse<bool>> AddEquipmentAsync(AddRemoveEquipmentGroupDto entityDto)
    {
        ...
        if (!validationResult.Result.IsValid)
        {
            ...
            return ServiceResponse.Failure<bool>(EntityErrorMessage<EquipmentGroup>.BadRequest(validationResult.Result.ToDictionary()));
        }
    ...
    public async Task<ServiceResponse<bool>> RemoveEquipmentAsync(AddRemoveEquipmentGroupDto entityDto)
    {
        var validator = new AddRemoveEquipmentGroupValidator(_repository, _equipmentRepository);
        var validationResult = validator.ValidateAsync(entityDto);
