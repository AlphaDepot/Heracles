...
{
    /// <summary>
    /// Creates a success serviceResponse for a create operation.
    /// </summary>
    ...
    public static void Success<TService, TEntity>(Mock<IAppLogger<TService>> logger, ServiceResponse<int> result, int expected, int id) where TEntity : BaseEntity
    {
    ...
    /// <summary>
    /// Creates a bad request serviceResponse with validation errors.
    /// </summary>
    ...
    /// <exception cref="InvalidOperationException">Thrown when trying to access the value of a failure serviceResponse.</exception>
    public static void BadRequest<TService, TEntity>(Mock<IAppLogger<TService>> logger, ServiceResponse<int> result, IDictionary<string, string[]> errors) where TEntity : BaseEntity
    {
