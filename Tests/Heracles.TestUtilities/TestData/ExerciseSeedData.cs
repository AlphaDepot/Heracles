...
public static class ExerciseSeedData
{
    ...
    public static List<MuscleGroup> MuscleGroups()
    {
        ...
        return
        [
            new MuscleGroup { Id = 1, Name = "Chest", CreatedAt = date, UpdatedAt = date, },
            new MuscleGroup { Id = 2, Name = "Back", CreatedAt = date, UpdatedAt = date, },
            new MuscleGroup { Id = 3, Name = "Legs", CreatedAt = date, UpdatedAt = date, },
            new MuscleGroup { Id = 4, Name = "Hamstrings", CreatedAt = date, UpdatedAt = date, },
            new MuscleGroup { Id = 5, Name = "Calves", CreatedAt = date, UpdatedAt = date, },
        ];
    }
    /// <summary>
    ...
    public static List<ExerciseMuscleGroup> ExerciseMuscleGroups()
    {
        ...
        [
            // first [0] or .First()
            new ExerciseMuscleGroup { Id = 1, ExerciseTypeId = 1, FunctionPercentage = 100,
                CreatedAt = date, UpdatedAt = date,
                Muscle = MuscleGroups().First(), 
                Function = MuscleFunctions().First() },
            // second [1]
            new ExerciseMuscleGroup { Id = 2, ExerciseTypeId = 2, FunctionPercentage = 100,
                CreatedAt = date, UpdatedAt = date,
                Muscle = MuscleGroups()[1],
                Function = MuscleFunctions()[1] },
            // third [2]
            new ExerciseMuscleGroup { Id = 3, ExerciseTypeId = 3, FunctionPercentage = 100,
                CreatedAt = date, UpdatedAt = date,
                Muscle = MuscleGroups()[2], 
                Function = MuscleFunctions()[2] },
            // fourth [3]
            new ExerciseMuscleGroup { Id = 4, ExerciseTypeId = 1, FunctionPercentage = 100,
                CreatedAt = date, UpdatedAt = date,
                Muscle = MuscleGroups()[3],
                Function = MuscleFunctions()[3] },
            // fifth [4]
            new ExerciseMuscleGroup { Id = 5, ExerciseTypeId = 1, FunctionPercentage = 100,
                CreatedAt = date, UpdatedAt = date,
    ...
    public static List<ExerciseType> ExerciseTypes()
    {
        ...
        [
            ...
            new ExerciseType { Id = 3, Name = "Deadlift",
                CreatedAt = date, UpdatedAt = date,
