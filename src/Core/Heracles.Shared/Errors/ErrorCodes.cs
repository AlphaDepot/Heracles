...
public static class ErrorTypes
{
	...
	public static AppError NullValue =>
		AppError.Create(ErrorCodes.NullValue, 400, ErrorMessages.NullValue);
	...
	public static AppError NotFound =>
		AppError.Create(ErrorCodes.NotFound, 404, ErrorMessages.NotFound);
	...
	public static AppError NamingConflict =>
		AppError.Create(ErrorCodes.NamingConflict, 400, ErrorMessages.NamingConflict);
	...
	public static AppError BadRequest =>
		AppError.Create(ErrorCodes.BadRequest, 400, ErrorMessages.InvalidRequest);
	...
	public static AppError DuplicateEntry =>
		AppError.Create(ErrorCodes.DuplicateEntry, 409, ErrorMessages.DuplicateEntry);
	...
	public static AppError IncompleteUserClaims =>
		AppError.Create(ErrorCodes.IncompleteUserClaims, 400, ErrorMessages.IncompleteUserClaims);

	/// <summary>
	///     Returns an unauthorized error.
	/// </summary>
	public static AppError Unauthorized =>
		AppError.Create(ErrorCodes.Unauthorized, 401, ErrorMessages.Unauthorized);
	...
	public static AppError Validation =>
		AppError.Create(ErrorCodes.Validation, 400, ErrorMessages.Validation);
	...
	public static AppError InvalidAppErrorType =>
		AppError.Create(ErrorCodes.InvalidErrorType, 400, ErrorMessages.InvalidErrorType);
	...
	public static AppError ConcurrencyAppError =>
		AppError.Create(ErrorCodes.ConcurrencyError, 409, ErrorMessages.ConcurrencyError);
	...
	public static AppError DatabaseAppError =>
		AppError.Create(ErrorCodes.DatabaseError, 500, ErrorMessages.DatabaseError);
	...
	{
		return AppError.Create(ErrorCodes.NotFound, 404, $"{entityName} {ErrorMessages.NotFound}");
	}
	...
	{
		return AppError.Create(ErrorCodes.NotFound, 404, message);
	}
	...
	{
		return AppError.Create(ErrorCodes.BadRequest, 400, message);
	}
	...
	{
		return AppError.Create(ErrorCodes.DuplicateEntry, 409,
	...
	{
		return AppError.Create(ErrorCodes.DatabaseError, 500, message);
	}
}
