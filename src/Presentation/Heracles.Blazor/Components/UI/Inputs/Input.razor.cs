...
using Heracles.Blazor.Internal;
using Heracles.Blazor.Utilities;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Forms;
using Microsoft.JSInterop;

namespace Heracles.Blazor.Components.UI.Inputs;
...
public partial class Input : ComponentBase
{
    ...
    private DotNetObjectReference<Input>? dotNetRef;
        ...
        if (firstRender)
        {
            try
            {
                jsModule = await JsRuntime.InvokeAsync<IJSObjectReference>(
                    "import", "./_content/Heracles.Blazor/js/text-input.js");
