...
var mediumZoom = function mediumZoom2(selector) {
  ...
  var getImages2 = function getImages3() {
    return images;
  };
  var getZoomedImage2 = function getZoomedImage3() {
  ...
  var zoom = {
    ...
    getImages: getImages2,
    getZoomedImage: getZoomedImage2
  };
  return zoom;
};
...
// js/image-zoom.ts
function createZoom(element, options) {
