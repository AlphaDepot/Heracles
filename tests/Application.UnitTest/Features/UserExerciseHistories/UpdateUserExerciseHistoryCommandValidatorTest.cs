...
public class UpdateUserExerciseHistoryCommandValidatorTest: FluentValidationBaseUnitTest
{
	...
	public  void UpdateUserExerciseHistoryCommandValidator_ShouldHaveError_WhenInputIsInvalid(int id, int userExerciseId, double weight, int repetition, string? concurrency, string? userId, string testForPropertyName)
	{
		var userExerciseHistory = new UpdateUserExerciseHistoryRequest()
		{
			Id = id,
